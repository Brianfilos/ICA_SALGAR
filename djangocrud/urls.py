...
urlpatterns = [
    ...
    path("proceso/RETE/verificar-firma/<int:declaracion_id>/", views.verificar_firma_rete, name="verificar_firma_rete"),
    path("proceso/RETE/reiniciar-firma/<int:declaracion_id>/", views.reiniciar_firma_rete, name="reiniciar_firma_rete"),
    path("pdf/rete/<int:rete_id>/", views.generar_pdf_rete, name="pdf_rete"),
