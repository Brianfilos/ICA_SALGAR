# Generated by Django 5.1.6 on 2026-03-27 05:05
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('tasks', '0035_remove_codigoestablecimiento'),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
    ]

    operations = [
        migrations.CreateModel(
            name='DeclaracionAutoRetencion',
            fields=[
                ...
                ('corrige_a', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='correcciones', to='tasks.declaracionautoretencion')),
                ('departamento', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='catalogos.departamento')),
                ('departamento_notificacion', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='autos_departamento_notificacion', to='catalogos.departamento')),
                ('municipio', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='catalogos.municipio')),
                ('municipio_notificacion', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='autos_municipio_notificacion', to='catalogos.municipio')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('declaracion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='actividades', to='tasks.declaracionautoretencion')),
            ],
            options={
                'ordering': ['orden'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('declaracion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='otps_firma', to='tasks.declaracionautoretencion')),
            ],
            options={
                'ordering': ['-creado_en'],
            },
